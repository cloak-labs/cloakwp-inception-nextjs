...
const myBlockConfig: BlocksConfig = {
  // We can override/extend how core blocks render like so:
  'core/heading': {
    // here we aren't overriding the heading block's Component or anything else, we're only extending it by adding custom props -- behind the scenes, it does a deep object merge rather than a full object override
    props: {
      // you can provide "props" where the children properties will get applied as component props to the associated Block component
      tags: {
